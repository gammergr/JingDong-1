...
import com.bwie.testten.mine.bean.JsonBean;
...
public class MeFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if (!name.equals("000")) {
            ...
            touxiang.setImageDrawable(circleDrawable);
        } else {
            touxiang.setImageResource(R.drawable.b3h);
